...
\caption{System architecture of Hybrid AI Defense: six scored layers (text, URL, crawl, visual, link, header) feed a weighted risk aggregator, with AI-authorship and XAI modules acting as signal modifiers and explanation providers.}\label{fig:architecture}
\end{figure}
