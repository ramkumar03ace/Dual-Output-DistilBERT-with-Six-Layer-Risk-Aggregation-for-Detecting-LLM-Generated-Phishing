/* ============================================
   Hybrid AI Defence — Gmail Content Script
...
(() => {
    ...
    async function extractHeaders() {
        ...
        try {
            ...
            console.warn('[Hybrid AI Defence] Header extraction error:', e);
        }
    ...
    console.log('[Hybrid AI Defence] Content script loaded on Gmail.');
})();
